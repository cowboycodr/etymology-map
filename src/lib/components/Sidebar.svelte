...
<div class="w-[196px] bg-bg-surface border-r border-border flex flex-col flex-shrink-0 max-md:fixed max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:h-[72dvh] max-md:w-full max-md:z-50 max-md:translate-y-full max-md:transition-transform max-md:duration-[260ms] max-md:cubic-bezier-[0.32,0.72,0,1] max-md:border-r-none max-md:border-t border-border max-md:rounded-t-2xl max-md:pb-[env(safe-area-inset-bottom,0px)]" class:max-md:translate-y-0={open}>
